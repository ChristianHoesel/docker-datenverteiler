...
rem #                                                                       #
rem #  Es wird angenommen, dass die Kernsoftware gemäß der allgmeinen       #
...
rem #  werden müssen überprüft und evtl. angepasst werden.                  #
rem #########################################################################
...
rem #########################################################################
rem #                                                                       #
rem #    Parameter für die Ausführung der Umfassenden Datenananalyse        #
rem #                                                                       #
rem #########################################################################

rem #########################################################################
rem #                                                                       #
rem #  der Name des auszuführenden Skripts (Dateiname)                      #
rem #                                                                       #
rem #########################################################################
...
rem #########################################################################
rem #                                                                       #
rem #  Zusätzliche Parameter für den Start der Java-VM                      #
rem #                                                                       #
rem #########################################################################
...
rem #                                                                       #
rem #  Ab hier darf in dem Skript keine Änderung mehr vorgenommen werden.   #
rem #                                                                       #
rem #########################################################################
